...
public class SortedListTest {
  ...
  public void addingToEndAndRemoving() {
    ...
    List<Integer> ul = new SortedList<Integer>(comp);
  ...
  public void listIteraterPrevious() {
    ...
    ListIterator<Integer> listItr = list.listIterator(100);
    int i = 0;
  ...
  public void testEqualElements() {
    SortedList<IntWrapper> list = new SortedList<IntWrapper>(new Comparator<IntWrapper>() {
  ...
  private static class IntWrapper implements Comparable<IntWrapper> {
    ...
    IntWrapper(int compValue, int otherValue) {
    ...
    public boolean equals(Object other) {
      return ((IntWrapper) other).compValue == compValue
          && ((IntWrapper) other).otherValue == otherValue;
    }
  }
}
